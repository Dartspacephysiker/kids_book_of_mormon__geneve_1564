...
And I, Moroni, am commanded to write these things so that evil can be destroyed, so that the time can come when Satan has no power over people's hearts. I write so that they will be persuaded to always do good, and come to the fountain of all righteousness and be saved.
