...
{ 
	...
	$startchapter = 6;
	$stopchapter = 11;
	$readingstr = "Nov 16–22 (Week ${weeknum})";
	$GoogleDrivelink = "https://drive.google.com/file/d/14Z0e1Cvl-Kuu9b0OLSOLihCQimyjHE6S/view?usp=sharing";
	$whichbook = 14;
    } elsif( $weeknum eq 46 ){
	$startchapter = 1;
	$stopchapter = 5;
	$readingstr = "Nov 9–15 (Week ${weeknum})";
	$GoogleDrivelink = "https://drive.google.com/file/d/1zyNxPFQB5B_hDmbfN_FRD-qhz4hT4DcE/view?usp=sharing";
	$whichbook = 14;
    } elsif( $weeknum eq 45 ){
	$startchapter = 7;
	$stopchapter = 9;
